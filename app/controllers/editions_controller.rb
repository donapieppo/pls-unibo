class EditionsController < ApplicationController
  ...
  def index
    authorize :edition
    @editions = Edition.includes(:events).visible(current_user&.staff?)
  ...
  def edition_params
    params[:edition].permit(
      :hidden, :in_evidence, :in_presence, :place, :google_map, :online, :access_url, :name, :description,
      ...
      :bookable_by_teacher_for_groups, :bookable_group_limit,
      :atomic
    )
  end
end
