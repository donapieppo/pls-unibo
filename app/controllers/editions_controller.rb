class EditionsController < ApplicationController
  ...
  def edition_params
    params[:edition].permit(:hidden, :in_evidence, :in_presence, :place, :google_map, :online, :access_url, :name, :description, :details, :academic_year, :audience_id, :seats, :sofia, :pcto, :bookable, :booking_url, :booking_start, :booking_end, :atomic)
  end
end
